    ...
    public class InstructionDecodesTests
    {
        ...
        {
            {
                ...
                Assert.AreEqual(
                    new IS(0, add_AL_BL[0], 2, IT.ADD, DWT.Byte, new IO(RT.AL), new IO(RT.BL)),
...

            {
                ...
                Assert.AreEqual(
                    new IS(0, add_BL_AL[0], 2, IT.ADD, DWT.Byte, new IO(RT.BL), new IO(RT.AL)),
        ...
        {
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_DAA[0], 1, IT.DAA, DWT.None),
...

            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, push_ES[0], 1, IT.PUSH, DWT.None, new IO(RT.ES)),
        ...
        public void WithLength2()
        {
            ...
            // MOV, 2 bytes
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_CX_BX[0], 2, IT.MOV, DWT.Word, new IO(RT.CX), new IO(RT.BX)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_CH_AH[0], 2, IT.MOV, DWT.Byte, new IO(RT.CH), new IO(RT.AH)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_DX_BX[0], 2, IT.MOV, DWT.Word, new IO(RT.DX), new IO(RT.BX)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_SI_BX[0], 2, IT.MOV, DWT.Word, new IO(RT.SI), new IO(RT.BX)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_BX_DI[0], 2, IT.MOV, DWT.Word, new IO(RT.BX), new IO(RT.DI)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_AL_CL[0], 2, IT.MOV, DWT.Byte, new IO(RT.AL), new IO(RT.CL)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_CH_CH[0], 2, IT.MOV, DWT.Byte, new IO(RT.CH), new IO(RT.CH)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_BX_AX[0], 2, IT.MOV, DWT.Word, new IO(RT.BX), new IO(RT.AX)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_BX_SI[0], 2, IT.MOV, DWT.Word, new IO(RT.BX), new IO(RT.SI)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_SP_DI[0], 2, IT.MOV, DWT.Word, new IO(RT.SP), new IO(RT.DI)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_BP_AX[0], 2, IT.MOV, DWT.Word, new IO(RT.BP), new IO(RT.AX)),
            ...
            // ADD, 2 bytes
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, add_AL_0x2A[0], 2, IT.ADD, DWT.Byte, new IO(RT.AL), new IO((byte)42, ImmediateFlag.None)),
            ...
            // JNL, 2 bytes
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, add_JNL_FFEE[0], 2, IT.JGE, DWT.None, new IO(unchecked((sbyte)0xEC), ImmediateFlag.RelativeJumpDisplacement)),
        ...
        public void WithLength3()
        {
            ...
            // MOV, 3 bytes
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_CX_0x0C[0], 3, IT.MOV, DWT.Word, new IO(RT.CX), new IO((ushort)12, ImmediateFlag.None)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_CX_0xFFF4[0], 3, IT.MOV, DWT.Word, new IO(RT.CX), new IO((short)-12, ImmediateFlag.None)),
            ...
            }
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, mov_DX_0xF6C[0], 3, IT.MOV, DWT.Word, new IO(RT.DX), new IO((ushort)3948, ImmediateFlag.None)),
            ...
            // ADD, 3 bytes
            {
                ...
                IS actual;
                Assert.AreEqual(
                    new IS(0, add_AX_neg4093[0], 3, IT.ADD, DWT.Word, new IO(RT.AX), new IO((short)-4093, ImmediateFlag.None)),
